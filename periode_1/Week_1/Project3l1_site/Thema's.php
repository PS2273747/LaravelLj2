...
<header id="header" class="d-flex flex-column justify-content-center">
  ...
  <nav id="navbar" class="navbar nav-menu">
    <ul>
      ...
      <li><a href="#" class="nav-link scrollto active"><i class="bi bi-yin-yang"></i> <span>Thema's</span></a></li>
...
<section id="home" class="d-flex flex-column justify-content-center">
    <div class="row">
        <div class="col d-flex flex-column justify-content-center">
            <div>
                    <h1>Welkom bij <span id="home_span">Thema's.</span></h1>
        ...
        <div class="col">
            <div class="humans_img">
                <img src="../Project3_site/assets/img/humans/standing-11.png">
            </div>
        </div>
    </div>
...
<figure class="card col-md-11" >
    <div class="row">
        <div>
            <p>Welkom op de thema's pagina. Hierop kun je alle thema's vinden en bijbehorende standpunten.</p>
        </div>
    </div>
</figure>
