...
<header id="header" class="d-flex flex-column justify-content-center">
  ...
  <nav id="navbar" class="navbar nav-menu">
    <ul>
      @foreach($nav_from_web_php as $navs)
      <li><a href="{{$navs}}"  class="nav-link scrollto active"><i class="bi bi-house"></i> <span>{{$navs}}</span></a></li>
      @endforeach
...
<figure class="card col-md-11" >
    ...
    Test ik moet dik, groot en onderstreept zijn
  </h1>
